...
{lvl:1, type:"choice", id:"bc5", ch:3, icon:"📉", title:"Le concurrent casse les prix",
 ...
 debrief:(B,k)=>`
  ...
  <p class="xptxt" style="border-left:2px solid var(--acc);padding-left:10px">Ce calcul a désormais son escalier : <b>Les exos · piste « Le prix »</b> — de « à quoi sert une élasticité » jusqu'au prix optimal, en passant par le volume qu'il faut pour compenser une remise. <span style="text-decoration:underline;cursor:pointer;font-weight:700" onclick="exoVersPiste('prix')">Y aller</span>.</p>
